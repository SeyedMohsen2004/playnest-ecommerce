...
- [Authentication and Browser Sessions](authentication.md) documents direct
  registration, dormant hashed-OTP compatibility rules, login throttling,
  HttpOnly refresh cookies, logout revocation, and CSRF handling.
