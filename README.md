...
<p align="center">
  ...
  />
  <img
    src="https://img.shields.io/badge/Tests-238-success"
    alt="238 backend tests"
  />
  <img
    src="https://img.shields.io/badge/Coverage-79.22%25-success"
    alt="79.22 percent branch-aware coverage"
  />
</p>
...
| Database | PostgreSQL |
| Payments | ZarinPal |
| Testing | 238 backend tests and 79.22% branch-aware coverage |
...
- 238 backend tests with 79.22% branch-aware coverage and a 76% CI regression gate.
...
- Direct phone-number registration with Django password validation,
  database-backed login controls, runtime-only access tokens, and HttpOnly
  refresh sessions.
...
- Dormant compatibility endpoints retain the hardened, hashed OTP lifecycle and
  configurable SMS adapters without making SMS part of storefront registration.
...
| Payments | ZarinPal |
| Legacy SMS compatibility | Kavenegar adapter and console failure-path adapter |
...
The verified baseline is 238 passing backend tests and 79.22% combined
