...
<p align="center">
  ...
  />
  <img
    src="https://img.shields.io/badge/Coverage-79.04%25-success"
    alt="79.04 percent branch-aware coverage"
  />
</p>
...
| Database | PostgreSQL |
| Payments | ZarinPal |
| Testing | 232 backend tests and 79.04% branch-aware coverage |
...
- 232 backend tests with 79.04% branch-aware coverage and a 76% CI regression gate.
...
The verified baseline is 232 passing backend tests and 79.04% combined
...
[`v1.1.0` portfolio release](https://github.com/SeyedMohsen2004/playnest-ecommerce/releases/tag/v1.1.0).
