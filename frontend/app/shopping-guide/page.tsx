...
const steps = [
  {
    title: "انتخاب محصول",
    description:
      "از صفحه محصولات، بازی‌های فکری، بردگیم‌ها، پازل‌ها و محصولات ساختنی را بر اساس دسته‌بندی، برند، رده سنی یا جستجو بررسی کنید و وارد صفحه جزئیات محصول شوید.",
  },
  {
  ...
  },
  {
    ...
    description:
      "برای ثبت سفارش، با شماره موبایل و رمز عبور وارد حساب کاربری شوید یا حساب جدید بسازید.",
  },
  {
...
export default function ShoppingGuidePage() {
  return (
    <LegalPageLayout
      title="راهنمای خرید"
      description="برای خرید از IpakToys کافی است چند مرحله ساده را طی کنید."
    >
